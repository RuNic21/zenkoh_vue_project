...
interface Props {
  ...
  formData: ProjectInsert; // プロジェクト編集フォームデータ
...
<template>
  <ModalShell :show="show" title="プロジェクト編集" size="md" @close="emit('close')">
    <template #default>
        ...
        <div class="form-section mt-4">
          ...
          <div class="form-check form-switch ps-0">
            <input 
              ...
              id="isArchivedEdit"
            >
            <label class="form-check-label text-body ms-3 text-truncate w-80" for="isArchivedEdit">
              <span class="font-weight-bold">アーカイブ状態</span>
              <small class="text-muted d-block">プロジェクトをアーカイブします</small>
            </label>
          </div>
        </div>
      </form>
