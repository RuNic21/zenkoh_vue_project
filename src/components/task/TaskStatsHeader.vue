...
const blockedCount = computed(() => props.tasks.filter(t => t.status === 'BLOCKED').length);
</script>
...
<style scoped>
/* 日本語コメント: 親のデザインに合わせるため個別スタイルは最小限 */
</style>
